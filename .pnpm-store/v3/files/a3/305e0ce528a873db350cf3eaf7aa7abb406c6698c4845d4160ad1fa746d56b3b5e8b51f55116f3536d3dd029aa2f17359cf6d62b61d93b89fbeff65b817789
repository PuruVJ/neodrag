...
const emoji_parseTest = require('./emoji/parse-test.cjs');
const emoji_variations = require('./emoji/variations.cjs');
...
exports.joinEmojiSequences = emoji_cleanup.joinEmojiSequences;
...
exports.splitEmojiSequences = emoji_cleanup.splitEmojiSequences;
...
exports.emojiSequenceToKeyword = emoji_format.emojiSequenceToKeyword;
...
exports.parseEmojiTestFile = emoji_parseTest.parseEmojiTestFile;
exports.addOptionalEmojiVariations = emoji_variations.addOptionalEmojiVariations;
