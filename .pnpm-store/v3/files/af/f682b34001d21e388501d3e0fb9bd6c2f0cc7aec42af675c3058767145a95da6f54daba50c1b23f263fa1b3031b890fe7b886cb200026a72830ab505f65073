...
export { getEmojiSequenceFromString, joinEmojiSequences, mapEmojiSequences, removeEmojiTones, removeEmojiVariations, splitEmojiSequences } from './emoji/cleanup.mjs';
...
export { emojiSequenceToKeyword, getEmojiSequenceString, getEmojiUnicodeString } from './emoji/format.mjs';
export { parseEmojiTestFile } from './emoji/parse-test.mjs';
export { addOptionalEmojiVariations } from './emoji/variations.mjs';
