...
function storeFileFunction(runDetails) {
    (0, fs_1.writeFileSync)((0, path_1.join)(cache_directory_1.projectGraphCacheDirectory, 'run.json'), JSON.stringify(runDetails, null, 2));
}
//# sourceMappingURL=store-run-information-life-cycle.js.map