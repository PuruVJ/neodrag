...
<script>
  import { Draggable } from '@neodrag/svelte'
	...
	const drag_0 = new Draggable({ plugins: [bounds(BoundsFrom.viewport())] });
...
Neodrag.shared.draggable(viewportElement, [bounds(BoundsFrom.viewport())]);
Neodrag.shared.draggable(parentElement, [bounds(BoundsFrom.parent())]);
```
...
<script>
  import { Draggable } from '@neodrag/svelte'
	...
	const drag_0 = new Draggable({ plugins: [bounds(BoundsFrom.viewport())] });
	const drag_1 = new Draggable({ plugins: [
    bounds(
      BoundsFrom.viewport({
        top: 20,
        left: 20,
...
<script>
  ...
  let container;
	...
	const drag_0 = new Draggable({ plugins: [bounds(() => BoundsFrom.element(container))] });
	const drag_1 = new Draggable({ plugins: [bounds(BoundsFrom.selector('#drop-zone'))] });
</script>
...
Neodrag.shared.draggable(bounded, [bounds(() => BoundsFrom.element(container))]);
Neodrag.shared.draggable(selector, [bounds(BoundsFrom.selector('#drop-zone'))]);
```
