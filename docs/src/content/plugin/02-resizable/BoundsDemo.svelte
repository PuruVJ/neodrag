<script lang="ts">
	...
	// bounds: 'parent' pins the anchored edge and stops the moving edge once it reaches the stage rect.
	// Drag any handle outward and the box clamps to the stage edge instead of overflowing.
	const resize = new Resizable({ minWidth: 90, minHeight: 70, bounds: 'parent' });
</script>

<DocDemo label="bounds: 'parent' — the box can't grow past the stage" hint="drag a handle outward; it stops at the edge">
	{#snippet stage()}
