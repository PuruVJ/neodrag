...
<script>
  ...
  import { disabled } from '@neodrag/svelte/plugins';

  const drag_0 = new Draggable({ plugins: [disabled(true)] });
  const drag_1 = new Draggable({ plugins: [disabled(false)] });
</script>

<!-- This won't drag at all -->
<div {@attach drag_0.attachment}>Can't drag me!</div>

<!-- This will drag normally -->
<div {@attach drag_1.attachment}>Can drag me!</div>
```
...
import { disabled, createDraggable } from '@neodrag/solid';
...
function DisabledExample() {
  ...
  createDraggable(element, [disabled(true)]);
...
```typescript
import { disabled, Neodrag } from '@neodrag/vanilla';

const element = document.getElementById('element');
Neodrag.shared.draggable(element, [disabled(true)]);
```
...
<script>
  ...
  const drag_0 = new Draggable({ plugins: [() => [disabledComp]] });
</script>
...
function ToggleDisabled() {
  ...
  createDraggable(element, [disabledComp]);
...
Neodrag.shared.draggable(element, () => [disabledComp]);
