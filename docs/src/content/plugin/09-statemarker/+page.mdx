...
```svelte
<script>
  import { Draggable, stateMarker } from '@neodrag/svelte';

	const drag_0 = new Draggable({ plugins: [stateMarker()] });
</script>
...
```typescript
import { stateMarker, Neodrag } from '@neodrag/vanilla';

const element = document.getElementById('draggable');

Neodrag.shared.draggable(element, [stateMarker()]);
```
...
<script>
  ...
  const plugins = [
	...
	const drag_0 = new Draggable({ plugins: plugins });
</script>

<div bind:this={dragElement} {@attach drag_0.attachment}>
  State: {currentState}
  <br />
...
```typescript
import { stateMarker, events, Neodrag } from '@neodrag/vanilla';
...
<div {@attach drag_0.attachment}>Drag me for notifications</div>
...
<script>
  ...
  const analyticsPlugins = [
	...
	const drag_0 = new Draggable({ plugins: analyticsPlugins });
</script>
...
<script>
  ...
  const debugPlugins = [
	...
	const drag_0 = new Draggable({ plugins: debugPlugins });
</script>

<div {@attach drag_0.attachment}>Drag me to see debug info</div>
