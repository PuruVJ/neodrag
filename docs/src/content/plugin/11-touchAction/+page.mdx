...
```svelte
<script>
  import { draggable, touchAction } from '@neodrag/svelte';
</script>
...
```svelte
<script>
  import { draggable, touchAction, Compartment } from '@neodrag/svelte';
...
import { touchAction, useCompartment } from '@neodrag/vue';
