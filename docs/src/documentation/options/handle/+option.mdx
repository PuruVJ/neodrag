...
<Examples client:load>
  <Example>
    ...
    <Code slot="codes">
      ...
      <div slot="angular">
        ```html
        <div [neoDraggable]="{ handle: '.handle' }">
          Won't drag ❌
  ...
  <Example>
    ...
    <Code slot="codes">
      ...
      <div slot="angular">
        ```html
        <div [neoDraggable]="{ handle: handleEl }">
          Won't drag ❌

          <div #handleEl>Drag me ✅</div>
        </div>
        ```
      </div>
  ...
  <Example>
    ...
    <Code slot="codes">
      ...
      <div slot="angular">
        ```html
        <div [neoDraggable]="{ handle: [handle1, handle2] }">
          Won't drag ❌

          <div #handle1>Drag me ✅</div>
          <div #handle2>Drag me ✅</div>
        </div>
        ```
      </div>
